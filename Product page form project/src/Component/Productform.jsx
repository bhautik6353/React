...
export default function Productform() {
    ...
    return (
<div>
<form id='s90' className='s3' onSubmit={handleSubmit}>
...
<a href="#s51"> <button className='s5'>Click to Slide</button></a>
...
<form id='s51' className='s85' action="" onSubmit={(e)=>handleSubmit2(e)}>
    ...
    <div  className="form1-group">
        ...
        <input type="number" placeholder='Product Price:' className="form-control" id="product" value={productPrice} onChange={(e)=>setProductPrice(e.target.value)} />
        ...
        </select>
        {
            ...
            {
              productCategory == "mobile" && <input type="text" className='mt-3' placeholder='Samsung' />
            }
            {
              productCategory == "mobile" && <input type="text" className='mt-3' placeholder='Apple' />
            }
            {
...
<a href="#s90"> <button className='s40'>Click to SlideDown</button></a>
<br /><br /><br /><br /><br />
