...
export default function Boottem() {
  return (
    <div>
  ...
  <div className="content-wrapper">
    <div className="container">
      ...
      <footer className="border-top">
        ...
        <p className="text-center text-muted pt-2">Distributed By: <a href="https://www.themewagon.com/" className="px-1" target="_blank">Themewagon</a></p>
      </footer>
